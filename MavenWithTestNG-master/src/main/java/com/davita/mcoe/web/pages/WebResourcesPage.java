 ...
 * @Company:CitiusTech
 */
public class WebResourcesPage extends WebPageBase {

	public WebResourcesPage(WebDriver driver) throws WaitException {
		super(driver);
	...
	public WebResourcesPage clickAccounts() throws TimeoutException, WaitException,
